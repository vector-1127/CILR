...
file = h5py.File('/home/changjianlong/datasets/STL10.h5')
...
x = Convolution2D(32, 5,5,init = 'he_normal')(x)
...
x = MaxPooling2D(pool_size = (4,4))(x)
x = Flatten()(x)
x = Dense(512,activation = 'relu',init = 'he_normal',activity_regularizer=activity_l1(1e-6))(x)
encode = BatchNormalization(mode=1)(x)
